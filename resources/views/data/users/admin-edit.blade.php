<x-layout>
    ...
    <form method="POST" action="/admin/user/{{ $data->foreignId }}" class="p-6 grid grid-cols-1 xl:grid-cols-2 gap-6">
        @csrf
        ...
        <div class="xl:col-span-2 bg-white border border-stone-200 rounded-xl px-8 py-6">
            <div class="flex justify-between items-center border-b border-stone-100 pb-4 mb-4">
                <div class="text-xl font-semibold text-stone-700">Rediģēt lietotāju</div>
            </div>
            ...
            <div class="mt-6 flex gap-3">
                ...
                <a href="/data/{{ $data->foreignId }}" class="px-4 py-2 border border-stone-300 rounded">Atcelt</a>
            </div>
        </div>
    </form>
</x-layout>
