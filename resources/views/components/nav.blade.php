@auth 
    <nav class="flex h-10 bg-white border-b-2 border-stone-200 items-center shrink-0 justify-between px-2">
        <div class="text-gray-700" onclick="sidebarSwich()">
            <svg id="collapsed-version" xmlns="http://www.w3.org/2000/svg" class="w-auto h-6" viewBox="0 0 24 24"> <!-- collapsed -->
            ...
            <svg id="full-version" xmlns="http://www.w3.org/2000/svg" class="w-auto h-6 hidden" viewBox="0 0 24 24"> <!-- full -->
                <g fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <div class="text-gray-700" onclick="modeSwich()">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-auto h-6 hidden dark:block" viewBox="0 0 24 24"> <!-- moon -->
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="w-auto h-6 block dark:hidden" viewBox="0 0 24 24"> <!-- sun -->
                <g fill="none">
