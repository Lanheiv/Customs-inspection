        ...
        <table id="users_table" class="min-w-full divide-y divide-stone-200 text-sm text-stone-700">
          <div class="min-w-full divide-y divide-stone-200 text-sm text-stone-700">
            <tr>
              ...
              <th class="px-4 py-2 text-left font-medium">Lietotājvārds</th>
              <th class="px-4 py-2 text-left font-medium">Loma</th>
              <th class="px-4 py-2 text-left font-medium">Stāvoklis</th>
